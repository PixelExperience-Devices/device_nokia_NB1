...
/* nokia.verify_modem("MODEM_VERSION") */
...
void Register_librecovery_updater_nokia() {
    RegisterFunction("nokia.verify_modem", VerifyModemFn);
    RegisterFunction("nokia.file_exists", FileExistsFn);
}
