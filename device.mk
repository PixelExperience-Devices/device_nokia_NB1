...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/system/system/android.hardware.nfc.hce.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.hardware.nfc.hce.xml \
    frameworks/native/data/etc/system/system/android.hardware.nfc.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/system/system/android.hardware.nfc.xml \
...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/wifi/bdwlan_nb1_def.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_nb1_def.bin \
    $(LOCAL_PATH)/configs/wifi/bdwlan_pkg_nb1.bin:$(TARGET_COPY_OUT_VENDOR)/etc/wifi/bdwlan_pkg_nb1.bin \
