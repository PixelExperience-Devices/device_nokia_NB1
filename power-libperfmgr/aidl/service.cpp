...
int main() {
    LOG(INFO) << "MSM8998 Power HAL AIDL Service with Extension is starting.";
    ...
    LOG(INFO) << "MSM8998 Power HAL AIDL Service with Extension is started.";
    ...
    // should not reach
    LOG(ERROR) << "MSM8998 Power HAL AIDL Service with Extension just died.";
    return EXIT_FAILURE;
}
